...
**Bookstore** The Bookstore is a website  that allows users to:
...
- ```cd math-magicians```
- git clone git@github.com:MostafaShahat2021/Bookstore.git

Install this project with:
1. Installed Git.
2. Create a local directory that you want to clone the repository.
3. Open the command prompt in the created directory.
4. On the terminal run this command git clone <git@github.com:MostafaShahat2021/Bookstore.git>
